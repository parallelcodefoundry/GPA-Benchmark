...
// cumulative material distribution, same summation order as the original inner loop
__constant__ double XS_MAT_CDF[12] = {
        0.0,
        (0.0 + 0.052),
        ((0.0 + 0.275) + 0.052),
        (((0.0 + 0.134) + 0.275) + 0.052),
        ((((0.0 + 0.154) + 0.134) + 0.275) + 0.052),
        (((((0.0 + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        ((((((0.0 + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        (((((((0.0 + 0.055) + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        ((((((((0.0 + 0.008) + 0.055) + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        (((((((((0.0 + 0.015) + 0.008) + 0.055) + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        ((((((((((0.0 + 0.025) + 0.015) + 0.008) + 0.055) + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052),
        (((((((((((0.0 + 0.013) + 0.025) + 0.015) + 0.008) + 0.055) + 0.066) + 0.064) + 0.154) + 0.134) + 0.275) + 0.052)
};

// picks a material based on a probabilistic distribution (table lookup)
__device__ int pick_mat( uint64_t * seed )
{
        double roll = LCG_random_double(seed);
        for( int i = 0; i < 12; i++ )
                if( roll < XS_MAT_CDF[i] )
                        return i;
        return 0;
}
