...
kernel_compute_cost(int num, int dim, long x, Point *p, int K, int stride,
					const float * __restrict__ coord_d, float *work_mem_d, const int * __restrict__ center_table_d, bool *switch_membership_d)
{
